...
class FrontierNavIntegrationTest {
	...
	private static final Path RESOURCES_PATH = ResourceHelper.getResourcePath("complete/resources.tsv");
	...
	void check_all_basic_probes() throws IOException {
		Mira mira = MiraLoader.loadMira(SITES_PATH, NETWORK_PATH, RESOURCES_PATH);
	...
	void check_all_custom_probes() throws IOException {
		FrontierNav frontierNav = FrontierNavLoader.loadFrontierNav(SITES_PATH, NETWORK_PATH, RESOURCES_PATH, PROBES_PATH);
